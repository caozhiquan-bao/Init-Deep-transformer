...
from MODEL.data import data_utils, FairseqDataset, iterators, Dictionary
...
class FairseqTask(object):
    ...
    def dataset(self, split):
        ...
        """
        from MODEL.data import FairseqDataset
    ...
    def build_generator(self, args):
        if args.score_reference:
            from MODEL.sequence_scorer import SequenceScorer
